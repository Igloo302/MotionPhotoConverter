# MotionPhotoConverter 功能说明

本文档详细介绍 MotionPhotoConverter 应用的各项功能及其使用方法。
...
MotionPhotoConverter 支持多种语言，包括英语、中文、法语、德语、西班牙语、日语和韩语。应用会自动根据设备的语言设置选择相应的语言。
...
MotionPhotoConverter 提供了一系列功能，使用户能够轻松地处理和转换 Motion Photo。通过直观的用户界面和高效的处理算法，应用为用户提供了良好的使用体验。未来版本将继续优化现有功能，并添加更多创新功能，以满足用户不断变化的需求。